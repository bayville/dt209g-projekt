...
<main class="wp-block-group">
  ...
  <div class="wp-block-columns container mt-md"><!-- wp:column {"width":"66.66%"} -->
    <div class="wp-block-column" style="flex-basis:66.66%">
      <!-- wp:query {"queryId":9,"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":true,"taxQuery":null,"parents":[],"format":[]}} -->
      <div class="wp-block-query"><!-- wp:post-template {"className":"archive__single"} -->
        ...
        <div class="wp-block-group"><!-- wp:post-title /-->
          ...
          <!-- wp:post-excerpt {"moreText":"Läs mer","excerptLength":30} /-->
        </div>
        <!-- /wp:group -->
        <!-- /wp:post-template -->
    ...
    <div class="wp-block-column widget__sidebar" style="flex-basis:33.33%">
      <!-- wp:search {"label":"Sök","widthUnit":"%","buttonText":"Sök","metadata":{"patternName":"gefle-workspace/search-widget","name":"Search Widget"},"className":"search-widget widget__container "} /-->
      ...
      <div class="wp-block-group widget__container p-md"><!-- wp:heading {"level":3} -->
        ...
        <!-- wp:categories {"showPostCounts":true,"className":" category-widget"} /-->
      </div>
      <!-- /wp:group -->
      ...
      <div
        class="wp-block-group widget__container has-white-color has-blue-background-color has-text-color has-background has-link-color">
        <!-- wp:heading {"level":3} -->
        ...
        <div class="wp-block-contact-form-7-contact-form-selector newsletter-widget">[contact-form-7 id="c6cb663"
          title="Nyhetsbrev"]</div>
